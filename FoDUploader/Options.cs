...
namespace FoDUploader
{
    class Options
    {
        public string GetUsage()
        {
            ...
            {
                Heading = new HeadingInfo("FoD Uploader", "1.01"),
        ...
        [Option("username", HelpText = "Your portal tenant account name and username separated by a backslash, e.g. Company\\userOne", MutuallyExclusiveSet = "userauth")]
